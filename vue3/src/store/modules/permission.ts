...
const viewsMap: Record<string, () => Promise<any>> = {
  ...
  'shipping/ewaybillPrint/index.vue': () => import('@/views/shipping/ewaybillPrint/index.vue'),
  ...
  'shipping/vendor_ship/index.vue': () => import('@/views/shipping/vendor_ship/index.vue'),
  'shipping/vendor_ship/index': () => import('@/views/shipping/vendor_ship/index.vue'),
  'shipping/cloud_warehouse/index': () => import('@/views/shipping/cloud_warehouse/index.vue'),
  'shipping/cloud_warehouse/manual_ship.vue': () => import('@/views/shipping/cloud_warehouse/manual_ship.vue'),
  'shipping/cloud_warehouse/manual_ship': () => import('@/views/shipping/cloud_warehouse/manual_ship.vue'),
  'shop/order/create': () => import('@/views/shop/order/create.vue'),
  'scm/price/AdminQuoteReview': () => import('@/views/scm/price/AdminQuoteReview.vue'),
}
